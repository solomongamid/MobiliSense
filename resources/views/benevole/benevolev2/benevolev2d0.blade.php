...
@section('content')
        ...
        <div class="row night">
          ...
          <div class="col-md-6">
            ...
            <ul>
              ...
              <li class="airtuyau"><img src="{{ asset('img/rond5.png') }}" />5. Air tuyau<sup><a class="sensorpdf" href="./files/Capteur_5.pdf" target="_blank"><i class="fas fa-external-link-alt"></i></a></sup> <span class="red">allumez l'appareil</span> <span class="grey">led verte clignotante</span></li>
            </ul>
          </div>
          <div class="col-md-2">
          </div>
      ...
      <script>
          ...
          d = n.getDate();
          document.getElementById("date").innerHTML = "Jour 0 : " + tab_jour[n.getDay()] + " " + d + " " + tab_mois[n.getMonth()] + " " + y;
    </script>
@endsection
