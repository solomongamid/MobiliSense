...
@section('content')
      ...
      <main class="maincontent mainuserhp">
        ...
        <div class="row rowbottom">
          ...
          <div class="col-md-6">
            ...
            <p class="beflist">Prenez <strong>3 mesures</strong> successives de votre tension avec les :</p>
            <ul>
              <li><img src="{{ asset('img/rond8.png') }}" />8. Tension-domicile<sup><a class="sensorpdf" href="./files/Capteur_8.pdf" target="_blank"><i class="fas fa-external-link-alt"></i></a></sup> + <img src="{{ asset('img/rond10.png') }}" />10. Smartphone</li>
            </ul>
            ...
            <ul>
              ...
              <li class="airtuyau"><img src="{{ asset('img/rond4.png') }}" />4. Air-bandoulière<sup><a class="sensorpdf" href="./files/Capteur_4.pdf" target="_blank"><i class="fas fa-external-link-alt"></i></a></sup> <span class="grey">led verte clignotante</span></li>
              <li><img src="{{ asset('img/rond6.png') }}" />6. Cardio-électrodes<sup><a class="sensorpdf" href="./files/Capteur_6.pdf" target="_blank"><i class="fas fa-external-link-alt"></i></a></sup> <span class="grey">led bleue clignotante</span></li>
            </ul>
      ...
      <script>
          ...
          d = n.getDate();
          document.getElementById("date").innerHTML = "Jour 6 : " + tab_jour[n.getDay()] + " " + d + " " + tab_mois[n.getMonth()] + " " + y;
    </script>
@endsection
